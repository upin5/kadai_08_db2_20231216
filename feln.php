...
SELECT * FROM manga_a_table WHERE id = 3;
...
<script type="text/javascript">
    ...
    <img src="feln_omoide.jpg" alt="フェルンの魔法" style="max-width:100%; height:auto">
    </div>
    <div style="text-align:center">
    <img src="fern_ct.jpg" alt="フェルンの戦い" style="max-width:100%; height:auto">
    </div>
