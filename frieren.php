...
SELECT * FROM manga_a_table WHERE id = 1;
...
<script type="text/javascript">
    ...
    <img src="frieren_magic.jpg" alt="魔法" style="max-width:100%; height:auto">
    </div>
    <div style="text-align:center">
    <img src="frieren_kiss.jpg" alt="キス" style="max-width:100%; height:auto">
    </div>
